...
Select 
  ...
  0 as id_complementar_sequencial,
...
/*
  ...
  */
  ...
  --ltf_cmb_grupos.id_seq_cmb_em_grupos
...
from lotofacil.lotofacil_filtros ltf_filtros,
  ...
  --lotofacil.lotofacil_combinacoes_em_grupos ltf_cmb_grupos
...
where ltf_filtros.ltf_id = ltf_bolas.ltf_id AND 
  ...
  --ltf_filtros.ltf_id = ltf_cmb_grupos.ltf_id and
  ...
  ltf_bolas.ltf_id = ltf_id.ltf_id
--ltf_bolas.ltf_id = ltf_dif.ltf_id and
  --ltf_bolas.ltf_id = ltf_comp.ltf_id and
  --ltf_bolas.ltf_id = ltf_cmb_grupos.ltf_id AND

  --ltf_id.ltf_id = ltf_dif.ltf_id AND
  --ltf_id.ltf_id = ltf_comp.ltf_id and
  --ltf_id.ltf_id = ltf_cmb_grupos.ltf_id and

  --ltf_dif.ltf_id = ltf_comp.ltf_id AND
  --ltf_dif.ltf_id = ltf_cmb_grupos.ltf_id
