...
CREATE INDEX lotofacil_id_classificado_idx_1 ON lotofacil.lotofacil_id_classificado(ltf_id);
CREATE INDEX lotofacil_id_classificado_idx_2 ON lotofacil.lotofacil_id_classificado(ltf_qt);
CREATE INDEX lotofacil_id_classificado_idx_3 ON lotofacil.lotofacil_id_classificado(par_impar_id);
CREATE INDEX lotofacil_id_classificado_idx_4 ON lotofacil.lotofacil_id_classificado(prm_id);
CREATE INDEX lotofacil_id_classificado_idx_5 ON lotofacil.lotofacil_id_classificado(prm_id);
CREATE INDEX lotofacil_id_classificado_idx_6 ON lotofacil.lotofacil_id_classificado(ext_int_id);
CREATE INDEX lotofacil_id_classificado_idx_7 ON lotofacil.lotofacil_id_classificado(hrz_id);
CREATE INDEX lotofacil_id_classificado_idx_8 ON lotofacil.lotofacil_id_classificado(vrt_id);
CREATE INDEX lotofacil_id_classificado_idx_9 ON lotofacil.lotofacil_id_classificado(dge_id);
CREATE INDEX lotofacil_id_classificado_idx_10 ON lotofacil.lotofacil_id_classificado(dgd_id);
CREATE INDEX lotofacil_id_classificado_idx_11 ON lotofacil.lotofacil_id_classificado(esq_dir_id);
CREATE INDEX lotofacil_id_classificado_idx_12 ON lotofacil.lotofacil_id_classificado(sup_inf_id);
CREATE INDEX lotofacil_id_classificado_idx_13 ON lotofacil.lotofacil_id_classificado(sup_esq_inf_dir_id);
CREATE INDEX lotofacil_id_classificado_idx_14 ON lotofacil.lotofacil_id_classificado(sup_dir_inf_esq_id);
CREATE INDEX lotofacil_id_classificado_idx_15 ON lotofacil.lotofacil_id_classificado(crz_id);
CREATE INDEX lotofacil_id_classificado_idx_16 ON lotofacil.lotofacil_id_classificado(lsng_id);
CREATE INDEX lotofacil_id_classificado_idx_17 ON lotofacil.lotofacil_id_classificado(qnt_id);
CREATE INDEX lotofacil_id_classificado_idx_18 ON lotofacil.lotofacil_id_classificado(trng_id);
CREATE INDEX lotofacil_id_classificado_idx_19 ON lotofacil.lotofacil_id_classificado(trio_id);
CREATE INDEX lotofacil_id_classificado_idx_20 ON lotofacil.lotofacil_id_classificado(x1_x2_id);
CREATE INDEX lotofacil_id_classificado_idx_21 ON lotofacil.lotofacil_id_classificado(dz_id);
CREATE INDEX lotofacil_id_classificado_idx_22 ON lotofacil.lotofacil_id_classificado(un_id);
CREATE INDEX lotofacil_id_classificado_idx_23 ON lotofacil.lotofacil_id_classificado(alg_id);
CREATE INDEX lotofacil_id_classificado_idx_24 ON lotofacil.lotofacil_id_classificado(sm_bolas_id);
CREATE INDEX lotofacil_id_classificado_idx_25 ON lotofacil.lotofacil_id_classificado(sm_alg_id);
CREATE INDEX lotofacil_id_classificado_idx_26 ON lotofacil.lotofacil_id_classificado(lc_id);
CREATE INDEX lotofacil_id_classificado_idx_27 ON lotofacil.lotofacil_id_classificado(bin_par_id);
CREATE INDEX lotofacil_id_classificado_idx_28 ON lotofacil.lotofacil_id_classificado(bin_impar_id);
CREATE INDEX lotofacil_id_classificado_idx_29 ON lotofacil.lotofacil_id_classificado(bin_primo_id);
CREATE INDEX lotofacil_id_classificado_idx_30 ON lotofacil.lotofacil_id_classificado(bin_nao_primo_id);
CREATE INDEX lotofacil_id_classificado_idx_31 ON lotofacil.lotofacil_id_classificado(bin_ext_id);
CREATE INDEX lotofacil_id_classificado_idx_32 ON lotofacil.lotofacil_id_classificado(bin_int_id);
CREATE INDEX lotofacil_id_classificado_idx_33 ON lotofacil.lotofacil_id_classificado(bin_hrz_1_id);
CREATE INDEX lotofacil_id_classificado_idx_34 ON lotofacil.lotofacil_id_classificado(bin_hrz_2_id);
CREATE INDEX lotofacil_id_classificado_idx_35 ON lotofacil.lotofacil_id_classificado(bin_hrz_3_id);
CREATE INDEX lotofacil_id_classificado_idx_36 ON lotofacil.lotofacil_id_classificado(bin_hrz_4_id);
CREATE INDEX lotofacil_id_classificado_idx_37 ON lotofacil.lotofacil_id_classificado(bin_hrz_5_id);
CREATE INDEX lotofacil_id_classificado_idx_38 ON lotofacil.lotofacil_id_classificado(bin_vrt_1_id);
CREATE INDEX lotofacil_id_classificado_idx_39 ON lotofacil.lotofacil_id_classificado(bin_vrt_2_id);
CREATE INDEX lotofacil_id_classificado_idx_40 ON lotofacil.lotofacil_id_classificado(bin_vrt_3_id);
CREATE INDEX lotofacil_id_classificado_idx_41 ON lotofacil.lotofacil_id_classificado(bin_vrt_4_id);
CREATE INDEX lotofacil_id_classificado_idx_42 ON lotofacil.lotofacil_id_classificado(bin_vrt_5_id);
CREATE INDEX lotofacil_id_classificado_idx_43 ON lotofacil.lotofacil_id_classificado(bin_dge_1_id);
CREATE INDEX lotofacil_id_classificado_idx_44 ON lotofacil.lotofacil_id_classificado(bin_dge_2_id);
CREATE INDEX lotofacil_id_classificado_idx_45 ON lotofacil.lotofacil_id_classificado(bin_dge_3_id);
CREATE INDEX lotofacil_id_classificado_idx_46 ON lotofacil.lotofacil_id_classificado(bin_dge_4_id);
CREATE INDEX lotofacil_id_classificado_idx_47 ON lotofacil.lotofacil_id_classificado(bin_dge_5_id);
CREATE INDEX lotofacil_id_classificado_idx_48 ON lotofacil.lotofacil_id_classificado(bin_dgd_1_id);
CREATE INDEX lotofacil_id_classificado_idx_49 ON lotofacil.lotofacil_id_classificado(bin_dgd_2_id);
CREATE INDEX lotofacil_id_classificado_idx_50 ON lotofacil.lotofacil_id_classificado(bin_dgd_3_id);
CREATE INDEX lotofacil_id_classificado_idx_51 ON lotofacil.lotofacil_id_classificado(bin_dgd_4_id);
CREATE INDEX lotofacil_id_classificado_idx_52 ON lotofacil.lotofacil_id_classificado(bin_dgd_5_id);
CREATE INDEX lotofacil_id_classificado_idx_53 ON lotofacil.lotofacil_id_classificado(bin_esq_id);
CREATE INDEX lotofacil_id_classificado_idx_54 ON lotofacil.lotofacil_id_classificado(bin_dir_id);
CREATE INDEX lotofacil_id_classificado_idx_55 ON lotofacil.lotofacil_id_classificado(bin_sup_id);
CREATE INDEX lotofacil_id_classificado_idx_56 ON lotofacil.lotofacil_id_classificado(bin_inf_id);
CREATE INDEX lotofacil_id_classificado_idx_57 ON lotofacil.lotofacil_id_classificado(bin_sup_esq_id);
CREATE INDEX lotofacil_id_classificado_idx_58 ON lotofacil.lotofacil_id_classificado(bin_inf_dir_id);
CREATE INDEX lotofacil_id_classificado_idx_59 ON lotofacil.lotofacil_id_classificado(bin_sup_dir_id);
CREATE INDEX lotofacil_id_classificado_idx_60 ON lotofacil.lotofacil_id_classificado(bin_inf_esq_id);
CREATE INDEX lotofacil_id_classificado_idx_61 ON lotofacil.lotofacil_id_classificado(bin_crz_1_id);
CREATE INDEX lotofacil_id_classificado_idx_62 ON lotofacil.lotofacil_id_classificado(bin_crz_2_id);
CREATE INDEX lotofacil_id_classificado_idx_63 ON lotofacil.lotofacil_id_classificado(bin_crz_3_id);
CREATE INDEX lotofacil_id_classificado_idx_64 ON lotofacil.lotofacil_id_classificado(bin_crz_4_id);
CREATE INDEX lotofacil_id_classificado_idx_65 ON lotofacil.lotofacil_id_classificado(bin_crz_5_id);
CREATE INDEX lotofacil_id_classificado_idx_66 ON lotofacil.lotofacil_id_classificado(bin_lsng_1_id);
CREATE INDEX lotofacil_id_classificado_idx_67 ON lotofacil.lotofacil_id_classificado(bin_lsng_2_id);
CREATE INDEX lotofacil_id_classificado_idx_68 ON lotofacil.lotofacil_id_classificado(bin_lsng_3_id);
CREATE INDEX lotofacil_id_classificado_idx_69 ON lotofacil.lotofacil_id_classificado(bin_lsng_4_id);
CREATE INDEX lotofacil_id_classificado_idx_70 ON lotofacil.lotofacil_id_classificado(bin_lsng_5_id);
CREATE INDEX lotofacil_id_classificado_idx_71 ON lotofacil.lotofacil_id_classificado(bin_qnt_1_id);
CREATE INDEX lotofacil_id_classificado_idx_72 ON lotofacil.lotofacil_id_classificado(bin_qnt_2_id);
CREATE INDEX lotofacil_id_classificado_idx_73 ON lotofacil.lotofacil_id_classificado(bin_qnt_3_id);
CREATE INDEX lotofacil_id_classificado_idx_74 ON lotofacil.lotofacil_id_classificado(bin_qnt_4_id);
CREATE INDEX lotofacil_id_classificado_idx_75 ON lotofacil.lotofacil_id_classificado(bin_qnt_5_id);
CREATE INDEX lotofacil_id_classificado_idx_76 ON lotofacil.lotofacil_id_classificado(bin_trng_1_id);
CREATE INDEX lotofacil_id_classificado_idx_77 ON lotofacil.lotofacil_id_classificado(bin_trng_2_id);
CREATE INDEX lotofacil_id_classificado_idx_78 ON lotofacil.lotofacil_id_classificado(bin_trng_3_id);
CREATE INDEX lotofacil_id_classificado_idx_79 ON lotofacil.lotofacil_id_classificado(bin_trng_4_id);
CREATE INDEX lotofacil_id_classificado_idx_80 ON lotofacil.lotofacil_id_classificado(bin_trio_1_id);
CREATE INDEX lotofacil_id_classificado_idx_81 ON lotofacil.lotofacil_id_classificado(bin_trio_2_id);
CREATE INDEX lotofacil_id_classificado_idx_82 ON lotofacil.lotofacil_id_classificado(bin_trio_3_id);
CREATE INDEX lotofacil_id_classificado_idx_83 ON lotofacil.lotofacil_id_classificado(bin_trio_4_id);
CREATE INDEX lotofacil_id_classificado_idx_84 ON lotofacil.lotofacil_id_classificado(bin_trio_5_id);
CREATE INDEX lotofacil_id_classificado_idx_85 ON lotofacil.lotofacil_id_classificado(bin_trio_6_id);
CREATE INDEX lotofacil_id_classificado_idx_86 ON lotofacil.lotofacil_id_classificado(bin_trio_7_id);
CREATE INDEX lotofacil_id_classificado_idx_87 ON lotofacil.lotofacil_id_classificado(bin_trio_8_id);
CREATE INDEX lotofacil_id_classificado_idx_88 ON lotofacil.lotofacil_id_classificado(bin_x1_id);
CREATE INDEX lotofacil_id_classificado_idx_89 ON lotofacil.lotofacil_id_classificado(bin_x2_id);
CREATE INDEX lotofacil_id_classificado_idx_90 ON lotofacil.lotofacil_id_classificado(bin_dz_0_id);
CREATE INDEX lotofacil_id_classificado_idx_91 ON lotofacil.lotofacil_id_classificado(bin_dz_1_id);
CREATE INDEX lotofacil_id_classificado_idx_92 ON lotofacil.lotofacil_id_classificado(bin_dz_2_id);
CREATE INDEX lotofacil_id_classificado_idx_93 ON lotofacil.lotofacil_id_classificado(bin_lc_1_id);
CREATE INDEX lotofacil_id_classificado_idx_94 ON lotofacil.lotofacil_id_classificado(bin_lc_2_id);
CREATE INDEX lotofacil_id_classificado_idx_95 ON lotofacil.lotofacil_id_classificado(bin_lc_3_id);
CREATE INDEX lotofacil_id_classificado_idx_96 ON lotofacil.lotofacil_id_classificado(bin_lc_4_id);
CREATE INDEX lotofacil_id_classificado_idx_97 ON lotofacil.lotofacil_id_classificado(bin_lc_5_id);
