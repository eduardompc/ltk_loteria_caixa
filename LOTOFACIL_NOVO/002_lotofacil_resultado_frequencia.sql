...
DROP FUNCTION IF EXISTS lotofacil.fn_lotofacil_resultado_frequencia_atualizar_2();
CREATE FUNCTION lotofacil.fn_lotofacil_resultado_frequencia_atualizar_2()
  RETURNS VOID
LANGUAGE plpgsql
AS $$
DECLARE
